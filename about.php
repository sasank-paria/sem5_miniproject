		          ...
		          <div class="col-md-12 d-flex align-items-center">
		            ...
		            <div class="tab-content ftco-animate" id="v-pills-tabContent">
		              ...
		              <div class="tab-pane fade show active" id="v-pills-whatwedo" role="tabpanel" aria-labelledby="v-pills-whatwedo-tab">
		              	<div>
			                <h2 class="mb-4">we offer great amount of events.</h2>
			              	<p>we have varieties of events and live shows.</p>
			                <p>we also take events order..</p>
				            </div>
		              </div>

		              <div class="tab-pane fade" id="v-pills-mission" role="tabpanel" aria-labelledby="v-pills-mission-tab">
		                <div>
			                <h2 class="mb-4">we host live events</h2>
			              	<p>we do live shows with independent artist</p>
			                <p>we also provide updates of events around you.</p>
				            </div>
		              </div>
		              ...
		              <div class="tab-pane fade" id="v-pills-goal" role="tabpanel" aria-labelledby="v-pills-goal-tab">
		                <div>
			                <h2 class="mb-4">Help Our Customer</h2>
			              	<p>we help our customer and clients to find events and shows in the city.</p>
			                <p>we do provide guidance to locate the venues.</p>
				            </div>
		              </div>
		            </div>
		          </div>
